#!/usr/bin/env python3
"""Test script for HfTransformers provider (Step 5 checklist)."""
...
try:
    from langextract_hftransformers import HfTransformersLanguageModel
except ImportError:
...
PROVIDER_CLS_NAME = "HfTransformersLanguageModel"
PATTERNS = ['^hftransformers']
...
print("Testing HfTransformers Provider - Step 5 Checklist:")
print("-" * 50)
...
try:
    ...
    provider = HfTransformersLanguageModel(model_id=model_id)
